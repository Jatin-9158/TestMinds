...
const Submit = () => {
  ...
  const isLoading = marks === null || quizId === null || InstructorEmailId === null;
      ...
      <div className="h-[30vh] w-[40vh] md:h-[40vh] md:w-[50vh] -mt-8 md:mt-0 md:p-10 bg-white rounded-sm md:rounded-md shadow-md flex flex-col p-6 border border-gray-300">
        {isLoading ? (
          ...
          <div className="animate-pulse flex flex-col space-y-4">
            ...
            <div className="h-10 w-1/2 mx-auto bg-gray-300 rounded"></div>
            <div className="h-6 w-3/4 mx-auto bg-gray-300 rounded"></div>
          ...
          <>
            ...
            <div className="text-center text-gray-600 mt-3 text-base">
              ...
              <h3 className="font-medium text-blue-700 hover:underline hover:text-blue-800">
                {InstructorEmailId}
              </h3>
            </div>
          </>
