          ...
          >
            ...
            <div className="md:w-full">
              <label
                ...
                className="font-bold text-sm md:text-base md:font-semibold text-pretty"
              >
                Email Address
              </label>
              <input
            ...
            <button
              className="py-2 w-full md:mb-2  text-center bg-blue-700  md:text-lg rounded-md font-bold text-white shadow-lg"
              type="submit"
            >
              Login
            </button>
